    ...
    <>
      ...
      <div className="bg-white rounded-2xl shadow-md overflow-hidden hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-1 flex flex-col h-full border border-gray-100">
        ...
        <div className="relative">
          ...
          {/* Si gen yon sample, nou ka mete yon ti badj sou imaj la tou */}
          {product.sample_link && (
            <span className="absolute top-3 right-3 bg-yellow-400 text-yellow-900 text-[10px] font-black px-2 py-1 rounded shadow-sm">
              PREVIEW GRATIS
            </span>
          )}
        </div>
        ...
        <div className="p-6 flex flex-col flex-grow text-black">
          ...
          <div className="mt-4 pt-4 border-t border-gray-50">
            ...
            {/* ZÒN BOUTON YO (2 Bouton kounye a) */}
            <div className="grid grid-cols-2 gap-3">
              {/* Bouton Preview (Parèt sèlman si sample_link egziste nan baz done a) */}
              {product.sample_link ? (
                <a 
                  href={product.sample_link} 
                  target="_blank" 
                  rel="noopener noreferrer"
                  className="flex items-center justify-center border-2 border-gray-200 text-gray-600 px-4 py-3 rounded-xl font-bold uppercase text-[10px] tracking-widest hover:bg-gray-50 transition"
                >
                  📖 Li yon moso
                </a>
              ) : (
                // Si pa gen sample, nou mete yon espas vid pou layout la pa kraze
                <div></div>
              )}

              <button 
                onClick={() => setIsModalOpen(true)}
                className="bg-black text-white px-4 py-3 rounded-xl font-black uppercase text-[10px] tracking-widest shadow-lg hover:bg-gray-800 active:scale-95 transition"
              >
                Achte Kounye a
              </button>
            </div>
              ...
              <div className="space-y-4">
                ...
                <button onClick={() => setPaymentMethod('natcash')} className="w-full bg-red-50 hover:bg-red-100 border border-red-200 p-4 rounded-2xl flex items-center justify-between group transition">
                  <div className="flex items-center gap-3">
                    ...
                    <div className="text-left"><p className="font-bold text-red-900 text-sm">Natcash</p><p className="text-[10px] text-gray-500">Retrait Ajan (*202#)</p></div>
                  </div>
                ...
                <button onClick={() => setPaymentMethod('moncash')} className="w-full bg-gray-50 hover:bg-gray-100 border border-gray-200 p-4 rounded-2xl flex items-center justify-between group transition">
                  <div className="flex items-center gap-3">
                    ...
                    <div className="text-left"><p className="font-bold text-gray-900 text-sm">MonCash</p><p className="text-[10px] text-gray-500">Transfè Senp (*212#)</p></div>
                  </div>
              ...
              <div className="animate-in slide-in-from-right duration-200">
                <div className="bg-red-50 p-5 rounded-2xl border border-red-100 text-center mb-6">
                  ...
                  <div className="text-left bg-red-100 p-3 rounded-lg">
                    ...
                    <ol className="text-[9px] text-red-900 space-y-1 list-decimal ml-3">
              ...
              <div className="animate-in slide-in-from-right duration-200">
                <div className="bg-gray-50 p-5 rounded-2xl border border-gray-200 text-center mb-6">
                  ...
                  <div className="text-left bg-gray-200 p-3 rounded-lg">
                    ...
                    <ol className="text-[9px] text-gray-800 space-y-1 list-decimal ml-3">
                      <li>Tape <b>*212#</b> sou telefòn ou.</li>
            ...
            {paymentMethod && (
              <form onSubmit={handleOrder} className="space-y-4">
                <div>
                  ...
                  <input type="text" required className="w-full bg-gray-50 border border-gray-100 p-4 rounded-xl text-black font-bold focus:ring-2 focus:ring-blue-500 outline-none" placeholder="Eg: 44332211" value={phone} onChange={(e) => setPhone(e.target.value)} />
                </div>
                <div>
                  <label className="text-[9px] font-black text-gray-400 uppercase ml-1">ID Tranzaksyon an</label>
                  <input type="text" required className="w-full bg-gray-50 border border-gray-100 p-4 rounded-xl text-black font-mono focus:ring-2 focus:ring-blue-500 outline-none" placeholder="Kole ID a la a..." value={transactionId} onChange={(e) => setTransactionId(e.target.value)} />
                </div>
